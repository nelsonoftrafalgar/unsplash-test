describe('Single photo', () => {
  beforeEach(() => {
    ...
    cy.get('[data-cy=single-collection-photo-overlay]')
      .first()
      .click()
  })

  it('clicking a photo opens a photo modal', () => {
    cy.get('[data-cy=single-photo-modal]')
      .should('be.visible')
  })

  it('photo modal should contain a photo', () => {
    cy.get('[data-cy=modal-photo]')
      .should('be.visible')
      .invoke('attr', 'src')
      .should('contain', 'unsplash')
  })
  ...
  it('clicking X closes the modal', () => {
    cy.get('[data-cy=single-photo-modal-close]')
      .click()
    cy.get('[data-cy=single-photo-modal]')
